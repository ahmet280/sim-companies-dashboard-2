...
function StatCard({ label, value, sub, color = "#00d4a8", trend, t, icon }) {
  const isDark = t.page === "#060d14";
  const borderColor = isDark ? `${color}30` : `${color}60`;
  const bgColor = isDark ? "linear-gradient(145deg, #0c1a28, #071018)" : "#ffffff";
  const glowColor = isDark ? `${color}10` : `${color}08`;
  ...
  return h("div", {
    style: {
      ...
      position: "relative",
      overflow: "hidden",
      boxShadow: isDark ? "0 4px 20px rgba(0,0,0,0.4)" : "0 2px 10px rgba(0,100,200,0.05)",
      transition: "transform 0.2s ease",
    }
  },
    h("div", { style: { position: "absolute", top: -20, right: -20, width: 80, height: 80, background: `radial-gradient(circle, ${glowColor} 0%, transparent 70%)`, borderRadius: "50%" } }),
    h("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", position: "relative", zIndex: 1 } },
      h("div", { style: { flex: 1 } },
        h("div", { style: { fontSize: 8.5, color: t.cardLabel, textTransform: "uppercase", letterSpacing: 1.2, marginBottom: 5, fontWeight: 600 } }, label),
        h("div", { style: { fontSize: 18, fontWeight: 800, color, letterSpacing: -0.5, lineHeight: 1 } }, value),
        sub && h("div", { style: { fontSize: 8.5, color: t.cardSub, marginTop: 5, fontWeight: 500, opacity: 0.8 } }, sub)
      ),
      trend != null && h("div", {
        style: {
          fontSize: 9,
...
function OzetPage({ bilancoData, gelirData, cashflow, t, styles, L, lang }) {
  ...
  return h("div", null,
    ...
    // Finansal Modelleme Section
    h("div", { style: { ...styles.panel, border: "1px solid #7c3aed40", background: "linear-gradient(135deg, rgba(124,58,237,0.05), transparent)" } },
      h("div", { style: { ...styles.sectionTitle, color: "#a78bfa" } }, L.sModelleme),
      h("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 10 } },
        h(StatCard, { 
          ...
          color: modelingData.isHealthy ? "#00d4a8" : "#f59e0b", t 
        }),
        h(StatCard, { 
          ...
          color: modelingData.isHealthy ? "#00d4a8" : "#ef4444", t 
        }),
        h("div", { style: { gridColumn: "span 2", padding: "10px 15px", background: "rgba(124,58,237,0.1)", borderRadius: 12, display: "flex", alignItems: "center", gap: 12 } },
          h("div", { style: { width: 38, height: 38, borderRadius: "50%", background: "#7c3aed20", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 } }, modelingData.isHealthy ? "🚀" : "⚠️"),
          h("div", null,
            h("div", { style: { fontSize: 10, fontWeight: 700, color: t.text } }, lang === "TR" ? "FİNANSAL PROJEKSİYON" : "FINANCIAL PROJECTION"),
            h("div", { style: { fontSize: 9, color: t.textMuted, marginTop: 2, lineHeight: 1.4 } }, 
        ...
        h("table", { style: { width: "100%", borderCollapse: "collapse" } },
          ...
          h("tbody", null, ...urunler.map((u, i) => {
            ...
            return h("tr", { key: i },
              ...
              h("td", { style: { ...td(unitProfit >= 0 ? "#10b981" : "#ef4444", t), minWidth: 80 } }, 
                h("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 2 } },
                  ...
                  h("div", { style: { width: "100%", height: 3, background: t.progBg, borderRadius: 2, overflow: "hidden" } },
                    h("div", { style: { width: Math.min(100, Math.abs(u.karMarji)) + "%", height: "100%", background: unitProfit >= 0 ? "#10b981" : "#ef4444" } })
                  )
                )
              ),
...
function SirketPage({ data, gelirData, cashflow, t, styles, L, lang }) {
  ...
  return h("div", null,
    ...
    dupont && h("div", { style: { ...styles.panel, border: "1px solid #00d4a840", background: "linear-gradient(135deg, rgba(0,212,168,0.05), transparent)" } },
      h("div", { style: { ...styles.sectionTitle, color: "#00d4a8" } }, L.sDupont),
      h("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 10 } },
        h(StatCard, { 
          label: L.cROE, 
    ...
    h("div", { style: { ...styles.panel, border: "1px solid #f59e0b40", background: "linear-gradient(135deg, rgba(245,158,11,0.05), transparent)" } },
      h("div", { style: { ...styles.sectionTitle, color: "#f59e0b" } }, L.sSenaryo),
      h("div", { style: { display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12 } },
        (() => {
          const scenarios = [
            { id: "kons", label: L.cKons, color: "#ef4444", factor: 0.9 },
            { id: "base", label: L.cBase, color: "#00d4a8", factor: 1.0 },
            { id: "opt", label: L.cOpt, color: "#10b981", factor: 1.1 }
          ];
          return scenarios.map(s => {
            ...
            return h("div", { key: s.id, style: { padding: "12px", background: isDark ? "#0a1520" : "#fff", border: `1px solid ${s.color}30`, borderRadius: 10, textAlign: "center" } },
              ...
              h("div", { style: { fontSize: 9, color: diff >= 0 ? "#10b981" : "#ef4444", fontWeight: 600 } }, 
